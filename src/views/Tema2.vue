...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-5(data-aos="fade-up") La planeación es fundamental para conseguir los objetivos de ventas. Los vendedores son personas que necesitan vender sus productos o servicios y para ello deben encontrar personas o empresas que tengan una necesidad o problema por resolver. En la siguiente imagen, se muestran algunos principios que hacen parte clave de la venta consultiva.
    ...
    .cajon.color-acento-contenido.p-5.mb-5(data-aos="fade-up")
    ...
    .tarjeta.tarjeta--gris.px-5.pt-5.pb-3.mb-5(data-aos="fade-up")
    ...
    .row.justify-content-center.align-items-stretch(data-aos="fade-up")
    ...
    p.mb-5(data-aos="fade-up") La segmentación hace referencia a una forma de organizar a los clientes en grupos más pequeños, según el tipo, y estos segmentos se deben caracterizar por atributos particulares, donde intervienen factores claves como: 
    ...
    TabsA.color-acento-contenido.mb-5(data-aos="fade-up")
      ...
      .tarjeta.color-secundario--claro.p-4(titulo="Hacer las preguntas adecuada")
      ...
      .tarjeta.color-secundario--claro.p-4(titulo="La formación del vendedor consultor")
        ...
        p Para llegar a ser un vendedor consultor,  para formarse bien en este excelente mundo de las ventas y ser exitoso, es necesario estar a la vanguardia de las nuevas técnicas de ventas y de los cambios que imponen el mercado y la modernidad tecnológica.
        .row
          .col-6
    ...
    .cajon.color-acento-contenido.p-5.half-img__container(data-aos="fade-up")
    ...
    p.mb-5(data-aos="fade-up") Para impulsar las ventas en las empresas, se debe contar con herramientas adecuadas para ofrecer sus productos o servicios, logrando destacar las ventajas competitivas de las mismas, facilitando la comunicación con los clientes y agilizando procesos comerciales de venta. Por lo tanto, a continuación, se identifican algunas de las herramientas que se utilizan para los diferentes tipos de ventas.
    ...
    p.mb-5(data-aos="fade-up") Las técnicas de ventas son los métodos que aplican los vendedores para vender de una manera más eficiente, con el propósito de alcanzar unos objetivos de venta en una empresa. Se hace necesario que realice la siguiente lectura:
    ...
    p(data-aos="fade-up") Aunque es evidente que los ciclos de compra y venta presentan algunas diferencias, haciendo un referente a la llegada del Internet, es posible observar que las cosas han cambiado: la empresa trabaja el ciclo de venta, preguntándose qué pasa, cuál es el mejor momento para contactar con sus clientes potenciales, cómo dirigirse a ellos, cómo debe argumentar los beneficios de un determinado producto.
    p.mb-5(data-aos="fade-up") Por su parte, el ciclo de compra es algo más libre, porque arranca en el momento en que el usuario se da cuenta de que tiene una necesidad, y acaba cuando este adquiere una solución a su problema. 
      b Observe más en detalle las partes fundamentales de un concepto de venta.

    TarjetaSelected.mb-5(data-aos="fade-up")

    p.mb-5(data-aos="fade-up") A continuación, se presentan diez (10) herramientas que es necesario incorporar en la cotidianidad como vendedores, herramientas que le ayudarán a ser más productivo, más efectivo, a mostrarse como ese profesional que siempre ha sabido que es.
